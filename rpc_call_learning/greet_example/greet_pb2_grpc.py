...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SayHello': grpc.unary_unary_rpc_method_handler(
                    servicer.SayHello,  #第一个参数叫behavior，实际上就是一个有输入和输出的方程
                    request_deserializer=greet__pb2.HelloRequest.FromString, # String-> Request = serialization
                    response_serializer=greet__pb2.HelloReply.SerializeToString, # Reply->String = deserialization
            ),
